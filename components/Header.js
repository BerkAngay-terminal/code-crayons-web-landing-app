...
function Header() {
    ...
    return (
        <header className='fixed top-0 right-0 left-0 flex bg-gray bg-opacity-10 items-center justify-between p-10 border-b border-gray-900'>
            ...
            {/* Logo */}
            <img className='h-8 md:h-10 lg:h-12 transform transition hover:scale-110 cursor-pointer' src="https://link-cdn.fra1.cdn.digitaloceanspaces.com/Link/codecrayons%20(1).png" alt="" />
